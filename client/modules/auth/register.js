...
// 리듀서 const register = (state = initialState, action) => {     switch
// (action.type) {         case REGISTER_SUCCESS:             return {
// ...state,                 isRegistered: true             }         case
// REGISTER_FAILURE:             return {                 ...state,
// isRegistered: false             }         default:             return state;
// } };
